  ...
  policy = <<POLICY
{
  ...
  "Statement": [
    ...
    "Resource" : [
      "arn:aws:s3:::${module.s3.s3_buckets.claims.bucket_id}/${each.value.home_directory}/*",
      "arn:aws:s3:::${module.s3.s3_buckets.claims.bucket_id}/${each.value.home_directory}*"
    ]
}
  ]
...
resource "aws_transfer_user" "this" {
  ...
  home_directory = "/${module.s3.s3_buckets.claims.bucket_id[0]}/${each.value.home_directory}"
